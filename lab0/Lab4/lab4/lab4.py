...
#If you get a state with no current variable assignment (at the Root of the search tree) then you should just
#return True, since forward checking could only be applied when there is some variable assignment. 
